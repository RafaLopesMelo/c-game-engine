...
void destroy(vulkan_context *context, vulkan_swapchain *vulkan_swapchain);
...
b8 vulkan_swapchain_present(vulkan_context *context,
                            vulkan_swapchain *swapchain, VkQueue graphics_queue,
...
void destroy(vulkan_context *context, vulkan_swapchain *swapchain) {
    ...
    // Only destroy the views. The swapchain owns the images and destroys them
    // automatically
    for (u32 i = 0; i < swapchain->image_count; ++i) {
    ...
    KINFO("Vulkan swapchain destroyed successfully!");
};
